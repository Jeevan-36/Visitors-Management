...
const ResidentDashboard = () => {
  ...
  return (
    <div className="bg-gray-900 text-gray-200 min-h-screen font-sans flex">
      <aside className={`bg-black w-64 p-6 flex flex-col justify-between h-screen fixed top-0 left-0 transform transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div>
          <div className="text-2xl font-bold mb-8 text-white">APT APT</div>
          <nav className="space-y-3">
            <Link to="/resident" className="flex items-center py-2 px-3 rounded-md hover:bg-gray-800 text-gray-300">Dashboard</Link>
            <Link to="/resident/approvals" className="flex items-center py-2 px-3 rounded-md hover:bg-gray-800 text-gray-300">Approvals</Link>
            <Link to="/resident/history" className="flex items-center py-2 px-3 rounded-md hover:bg-gray-800 text-gray-300">History</Link>
            <Link to="/resident/settings" className="flex items-center py-2 px-3 rounded-md hover:bg-gray-800 text-gray-300">Settings</Link>
          </nav>
        </div>
        <div className="border-t border-gray-700 pt-6">
          ...
          <Link to="/logout" className="block mt-4 py-2 px-3 rounded-md hover:bg-gray-800 text-gray-300 text-sm">Logout</Link>
        </div>
      </aside>
      ...
      <main className={`flex-1 p-8 transition-all duration-300 ease-in-out ${isSidebarOpen ? 'ml-64' : 'ml-0'}`}>
        <header className="flex justify-between items-center mb-8">
          <div className="flex items-center">
            ...
            <h2 className="text-3xl font-bold text-white">Resident Dashboard</h2>
          </div>
        </header>
